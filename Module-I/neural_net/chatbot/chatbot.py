...
class Chatbot:
    ...
    def initResponseCall(self, args=None):
        self.args = self.parseArgs(['--test', 'interactive'])
        ...
        if '12' in tf.__version__:
            self.saver = tf.train.Saver(max_to_keep=200, write_version=1)
        else:
    ...
    def mainTestInteractive(self, sess):
        ...
        print('')
        print('Welcome to the interactive mode. Don\'t have high '
